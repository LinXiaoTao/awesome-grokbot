...
export function BotCard({ bot }: BotCardProps) {
  ...
  return (
    <article
      className={cn(
        "group relative flex h-full min-h-[240px] flex-col rounded-2xl border border-border/80 bg-white p-5 md:p-6",
    ...
    >
      ...
      <div className="relative z-10 mt-auto space-y-3 border-t border-neutral-100 pt-3">
        ...
        <div className="flex items-center justify-between gap-2">
          <button
            ...
            className="relative z-10 inline-flex min-h-9 items-center gap-1.5 rounded-lg border border-neutral-200 bg-neutral-50 px-3 py-1.5 text-xs font-medium text-neutral-700 transition-colors hover:border-neutral-300 hover:bg-neutral-100"
          >
            {copied ? (
              <>
          ...
          {bot.xaiBotUrl && (
            <a
              ...
              className="relative z-10 inline-flex min-h-9 items-center gap-1 rounded-lg px-2.5 py-1.5 text-xs font-medium text-neutral-500 transition-colors hover:bg-neutral-100 hover:text-neutral-900"
            >
